...
#Additional flags
PREPROCESSOR_MACROS += ARM_MATH_CM4 flash_layout STM32G431CB
INCLUDE_DIRS += .
LIBRARY_DIRS += 
LIBRARY_NAMES += 
...
CXXFLAGS += 
ASFLAGS += 
LDFLAGS += --specs=nano.specs --specs=nosys.specs -Wl,--no-warn-rwx-segments
COMMONFLAGS += -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=hard
LINKER_SCRIPT := $(BSP_ROOT)/STM32G4xxxx/LinkerScripts/STM32G431CB_flash.lds
